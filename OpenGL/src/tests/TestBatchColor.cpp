...
Renderer test::TestBatchColor::renderer = Renderer();

test::TestBatchColor::TestBatchColor()
    : transform(glm::vec3(0.f, 0.f, 0.f))
{
    m_Shader = std::make_unique<Shader>("F:/vs/TheCherno/OpenGL/res/shaders/BatchColor.glsl");
    ...
    float box[] = {
        -1.5f, -0.5f, 0.f, 0.1f, 0.2f,  0.96f, 1.f,
        -0.5f, -0.5f, 0.f, 0.1f, 0.2f,  0.96f, 1.f,
        -0.5f,  0.5f, 0.f, 0.1f, 0.2f,  0.96f, 1.f,
        -1.5f,  0.5f, 0.f, 0.1f, 0.2f,  0.96f, 1.f,

         0.5f, -0.5f, 0.f, 1.f,  0.96f, 0.2f,  1.f,
         1.5f, -0.5f, 0.f, 1.f,  0.96f, 0.2f,  1.f,
         1.5f,  0.5f, 0.f, 1.f,  0.96f, 0.2f,  1.f,
         0.5f,  0.5f, 0.f, 1.f,  0.96f, 0.2f,  1.f
    };
    m_VBO = std::make_unique<VertexBuffer>(box, 8 * (4 + 3) * sizeof(float), DrawMode::Dynamic);
