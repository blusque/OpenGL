...
Renderer test::TestBatchTexture::renderer = Renderer();

test::TestBatchTexture::TestBatchTexture()
    : transform(glm::vec3(0.f, 0.f, 0.f))
{
    m_Shader = std::make_unique<Shader>("F:/vs/TheCherno/OpenGL/res/shaders/BatchTexture.glsl");
    ...
    float box[] = {
        -1.5f, -0.5f, 0.f, 0.f, 0.f,
        -0.5f, -0.5f, 0.f, 1.f, 0.f,
        -0.5f,  0.5f, 0.f, 1.f, 1.f,
        -1.5f,  0.5f, 0.f, 0.f, 1.f,

         0.5f, -0.5f, 0.f, 0.f, 0.f,
         1.5f, -0.5f, 0.f, 1.f, 0.f,
         1.5f,  0.5f, 0.f, 1.f, 1.f,
         0.5f,  0.5f, 0.f, 0.f, 1.f
    };
    m_VBO = std::make_unique<VertexBuffer>(box, 8 * (4 + 2) * sizeof(float), DrawMode::Dynamic);
